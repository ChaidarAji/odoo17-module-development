...
def get_blink(frame):
 #-----Step 3: Face detection with dlib-----
    ...
    for face in faces:
        print('aaaaaaaaaaaaaaaaaaaaaaaaaaa', face)
...
while True:
    ...
    face_current_frame = face_recognition.face_locations(frame)
    for faceLoc in face_current_frame:
    ...
    #         cv2.putText(frame2,"BLINKING",(10,50), cv2.FONT_HERSHEY_SIMPLEX,
    ...
    cv2.imshow('BlinkDetector', frame2)
    key = cv2.waitKey(1)
    if key == 27:
        break
